...
@section('title', 'Express Delivery UK Orders List')

@section('content')
    <div class="content-wrapper">
        <!-- START PAGE CONTENT-->
        <div class="page-heading">
            <h1 class="page-title">Express Delivery UK Orders List</h1>
            <ol class="breadcrumb">
        ...
        <div class="page-content fade-in-up">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Express Delivery UK Orders List</div>
                    @if (session('success'))
