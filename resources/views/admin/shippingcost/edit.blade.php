...
<div class="content-wrapper">
    ...
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div>
                <a href="{{ route('admin.buyorders.shippingindex') }}" class="btn btn-primary">Back</a>
            </div>
          
        </div>
        <form action="{{ route('admin.buyOrder.shippingupdate', $order->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')        
            <div class="ibox-body">
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <strong><label for="order_price">Order Price</label></strong>
                        <input type="text" name="order_price" id="order_price" class="form-control" value="{{ old('order_price', $order->order_price) }}">
                    </div>
        
                    <div class="col-md-6 mb-3">
                        <strong><label for="shipping_charge">Shipping Charge</label></strong>
                        <input type="text" name="shipping_charge" id="shipping_charge" class="form-control" value="{{ old('shipping_charge', $order->shipping_charge) }}">
                    </div>
                </div>
