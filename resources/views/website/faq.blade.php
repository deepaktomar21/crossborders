...
<main class="main">
    <div class="page-header text-center" style="background-color: rgb(54, 50, 50); color: orange; padding: 50px 0;">
        <div class="container">
            <h1 class="page-title" style="color: orange;">F.A.Q <span style="color: orange;">Page</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
            ...
            <div class="accordion accordion-rounded" id="accordion-1">
                <div class="card card-box card-sm bg-light">
                    <div class="card-header" id="heading-1">
                        <h2 class="card-title">
                            <a role="button" data-toggle="collapse" href="#collapse-1" aria-expanded="true"
                                ...
                                Do you only courier small packages or deal with goods of all weights?
                            </a>
                        </h2>
                    </div><!-- End .card-header -->
                    <div id="collapse-1" class="collapse show" aria-labelledby="heading-1"
                        ...
                        <div class="card-body">
                            Although our speciality is in delivering small packages by express (air-freight) service, its worthy
to note that we ship all kinds of goods. Being your consultant in this area, if you want large packages
delivered express, we shall discuss various options (standard and express) and the pricing with you
and deliver according to your desire
                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
